...
export const Icon = React.forwardRef(({ data, width, height, size, className, fill = 'currentColor', stroke = 'none', qa }, ref) => {
    ...
    if (isStringSvgData(data)) {
        ...
        return _jsx("svg", Object.assign({}, props, { ref: ref, dangerouslySetInnerHTML: { __html: preparedData } }));
    }
    if (isSpriteData(data)) {
        const href = Icon.prefix + (data.url || `#${data.id}`);
        return (_jsx("svg", Object.assign({}, props, { viewBox: viewBox, ref: ref, children: _jsx("use", { href: href, xlinkHref: href }) })));
    }
    ...
    return (_jsx("svg", Object.assign({}, props, { ref: ref, children: _jsx(IconComponent, { width: undefined, height: undefined }) })));
});
