...
export declare function DefaultDisclosureSummary({ onClick, ariaControls, id, expanded, disabled, }: DisclosureSummaryRenderFunctionProps): import("react/jsx-runtime").JSX.Element;
export {};
