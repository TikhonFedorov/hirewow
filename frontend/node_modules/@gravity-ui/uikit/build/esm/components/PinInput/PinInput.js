...
export const PinInput = React.forwardRef((props, ref) => {
    ...
    return (_jsxs("div", Object.assign({ ref: ref }, filterDOMProps(otherProps, { labelable: true }), focusWithinProps, { className: b({ size, responsive }, className), style: style, "data-qa": qa, role: "group", id: id, "aria-describedby": ariaDescribedBy, children: [_jsxs("div", { className: b('items'), children: [Array.from({ length }).map((__, i) => {
                        var _a, _b;
                        const inputId = `${id}-${i}`;
