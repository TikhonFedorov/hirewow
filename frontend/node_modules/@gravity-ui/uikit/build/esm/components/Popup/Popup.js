...
export function Popup({ keepMounted = false, hasArrow = false, offset = [0, 4], open, placement, anchorRef, disableEscapeKeyDown, disableOutsideClick, disableLayer, style, className, contentClassName, modifiers = [], children, onEscapeKeyDown, onOutsideClick, onClose, onClick, onMouseEnter, onMouseLeave, onFocus, onBlur, onTransitionEnter, onTransitionEntered, onTransitionExit, onTransitionExited, disablePortal, container, strategy, qa, restoreFocus, restoreFocusRef, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, role: roleProp, id, focusTrap = false, autoFocus = false, 'aria-modal': ariaModal = focusTrap, }) {
    ...
    return (_jsx(CSSTransition, { nodeRef: containerRef, in: open, addEndListener: (done) => { var _a; return (_a = containerRef.current) === null || _a === void 0 ? void 0 : _a.addEventListener('animationend', done); }, classNames: getCSSTransitionClassNames(b), mountOnEnter: !keepMounted, unmountOnExit: !keepMounted, appear: true, onEnter: () => {
        ...
        }, children: _jsx(Portal, { container: container, disablePortal: disablePortal, children: _jsx("div", Object.assign({ ref: handleRef, style: styles.popper }, attributes.popper, containerProps, { className: b({ open }, className), "data-qa": qa, id: id, role: role, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, "aria-modal": ariaModal && open ? ariaModal : undefined, children: _jsx(FocusTrap, { enabled: focusTrap && open, autoFocus: autoFocus, children: _jsxs("div", { onClick: onClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onFocus: onFocus, onBlur: onBlur, className: b('content', contentClassName), style: style, tabIndex: -1, children: [hasArrow && (_jsx(PopupArrow, { styles: styles.arrow, attributes: attributes.arrow, setArrowRef: setArrowRef })), children] }) }) })) }) }));
}
