...
export const RadioButton = React.forwardRef(function RadioButton(props, ref) {
    ...
    return (_jsxs("div", Object.assign({}, containerProps, { ref: ref, style: style, className: b({ size, width }, className), "data-qa": qa, children: [_jsx("div", { ref: plateRef, className: b('plate'), onTransitionEnd: handlePlateTransitionEnd, hidden: true }), optionsProps.map((optionProps) => (_createElement(Option, Object.assign({}, optionProps, { key: optionProps.value, ref: optionProps.checked ? handleCheckedOptionMount : undefined }))))] })));
});
