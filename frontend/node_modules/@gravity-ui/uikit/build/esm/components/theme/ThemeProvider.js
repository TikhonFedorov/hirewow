...
export function ThemeProvider({ theme: themeProp, systemLightTheme: systemLightThemeProp, systemDarkTheme: systemDarkThemeProp, direction: directionProp, nativeScrollbar, scoped: scopedProp = false, rootClassName = '', children, layout, }) {
    ...
    return (_jsx(PrivateLayoutProvider, Object.assign({}, layout, { children: _jsx(ThemeContext.Provider, { value: contextValue, children: _jsx(ThemeSettingsContext.Provider, { value: themeSettingsContext, children: scoped ? (_jsx("div", { className: b({
                        theme: themeValue,
