...
export const TextArea = React.forwardRef(function TextArea(props, ref) {
    ...
    return (_jsxs("span", { ref: ref, style: style, className: b({
        ...
        }, className), "data-qa": qa, children: [_jsxs("span", { className: b('content'), children: [_jsx(TextAreaControl, Object.assign({}, props, commonProps, { controlRef: handleRef })), isClearControlVisible && (_jsx(ClearButton, { className: b('clear', { size }), size: mapTextInputSizeToButtonSize(size), onClick: handleClear }))] }), _jsx(OuterAdditionalContent, { errorMessage: isErrorMsgVisible ? errorMessage : null, errorMessageId: errorMessageId, note: note, noteId: noteId })] }));
});
