...
export const TextInput = React.forwardRef(function TextInput(props, ref) {
    ...
    return (_jsxs("span", { ref: ref, style: style, className: b({
            ...
            'has-unstable-end-content': isUnstableEndContentVisible,
                        ...
                        }, className: b('label'), title: label, htmlFor: id, children: `${label}` })), _jsx(TextInputControl, Object.assign({}, props, commonProps, { controlRef: handleRef })), isClearControlVisible && (_jsx(ClearButton, { size: mapTextInputSizeToButtonSize(size), onClick: handleClear, className: b('clear', { size }) })), isEndContentVisible && (_jsx(AdditionalContent, { placement: "end", onClick: handleAdditionalContentClick, children: endContent })), isErrorIconVisible && (_jsx(Popover, { content: errorMessage, children: _jsx("span", { "data-qa": CONTROL_ERROR_ICON_QA, children: _jsx(Icon, { data: TriangleExclamation, className: b('error-icon'), size: size === 's' ? 12 : 16 }) }) })), isUnstableEndContentVisible && (_jsx(AdditionalContent, { placement: "end", onClick: handleAdditionalContentClick, children: unstableEndContent }))] }), _jsx(OuterAdditionalContent, { note: note, errorMessage: isErrorMsgVisible ? errorMessage : null, noteId: noteId, errorMessageId: errorMessageId })] }));
});
