...
export const Checkbox = React.forwardRef(function Checkbox(props, ref) {
    ...
    const control = (_jsxs("span", { className: b('indicator'), children: [_jsx("span", { className: b('icon'), "aria-hidden": true, children: indeterminate ? (_jsx(CheckboxDashIcon, { className: b('icon-svg', { type: 'dash' }) })) : (_jsx(CheckboxTickIcon, { className: b('icon-svg', { type: 'tick' }) })) }), _jsx("input", Object.assign({}, inputProps, { className: b('control') })), _jsx("span", { className: b('outline') })] }));
