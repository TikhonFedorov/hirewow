...
export function withTableSelection(TableComponent) {
    ...
    return _a = class extends React.Component {
            ...
            render() {
                ...
                return (_jsx(TableComponent, Object.assign({}, restTableProps, { columns: this.enhanceColumns(columns), onRowClick: this.enhanceOnRowClick(onRowClick), getRowDescriptor: this.enhanceGetRowDescriptor(getRowDescriptor) })));
            }
