...
const useDndRenderContainer = ({ onDragEnd, renderControls }) => {
    ...
    const dndRenderContainer = ({ renderItem, list, containerRef, id, className, }) => {
        ...
        return (_jsxs(React.Fragment, { children: [_jsxs(ListContainerView, { ref: containerRef, id: id, className: className, children: [stickyStartItemList, _jsx(DragDropContext, { onDragEnd: onDragEnd, children: _jsx(Droppable, { droppableId: uniqId, renderClone: renderDndActiveItem, children: (droppableProvided) => {
                                    return (_jsxs("div", Object.assign({}, droppableProvided.droppableProps, { ref: droppableProvided.innerRef, children: [sortableItemList, droppableProvided.placeholder] })));
...
const useDndRenderItem = (sortable) => {
    const renderDndItem = ({ data: item, props, index, renderContainerProps, }) => {
        ...
        const commonProps = Object.assign(Object.assign({}, props), { selected, selectionViewType: item.isRequired ? 'single' : 'multiple', content: Object.assign(Object.assign({}, props.content), { startSlot,
                endSlot }) });
        if (isDragDisabled) {
            return _createElement(ListItemView, Object.assign({}, commonProps, { key: commonProps.id }));
        }
        const renderItem = (provided, snapshot) => (_jsx(ListItemView, Object.assign({}, commonProps, provided.draggableProps, provided.dragHandleProps, { ref: provided.innerRef, dragging: snapshot.isDragging })));
...
export const TableColumnSetup = (props) => {
    ...
    const renderControl = ({ toggleOpen }) => {
        ...
        return ((renderSwitcher === null || renderSwitcher === void 0 ? void 0 : renderSwitcher({ onClick: toggleOpen, onKeyDown })) || (_jsxs(Button, { onClick: toggleOpen, extraProps: { onKeyDown }, children: [_jsx(Icon, { data: Gear }), i18n('button_switcher')] })));
    };
