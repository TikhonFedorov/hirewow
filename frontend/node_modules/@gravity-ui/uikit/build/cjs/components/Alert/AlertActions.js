...
const AlertActions = ({ items, children, className }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(layout_1.Flex, { className: (0, constants_1.bAlert)('actions', { minContent: layout === 'horizontal' }, className), direction: "row", gap: "3", wrap: true, alignItems: layout === 'horizontal' ? 'center' : 'flex-start', children: (items === null || items === void 0 ? void 0 : items.map(({ handler, text }, i) => ((0, jsx_runtime_1.jsx)(AlertAction_1.AlertAction, { onClick: handler, children: text }, i)))) || children }));
};
