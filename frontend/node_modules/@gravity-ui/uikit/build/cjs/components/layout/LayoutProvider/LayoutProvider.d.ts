...
export declare function PrivateLayoutProvider({ children, config: override, initialMediaQuery, }: PrivateLayoutProviderProps): import("react/jsx-runtime").JSX.Element;
 ...
 */
export declare function LayoutProvider({ children }: LayoutProviderProps): React.ReactNode;
export {};
