...
exports.Flex = React.forwardRef(function Flex(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Box_1.Box, Object.assign({ as: as, className: b({
            ...
            rowGap, alignContent: applyMediaProps(alignContent), alignItems: applyMediaProps(alignItems), alignSelf: applyMediaProps(alignSelf), justifyContent: applyMediaProps(justifyContent), justifyItems: applyMediaProps(justifyItems), justifySelf: applyMediaProps(justifySelf) }, style) }, restProps, { children: space
