...
const ClearButton = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Button_1.Button, { size: size, className: b(null, className), onClick: onClick, extraProps: {
            onMouseDown: preventDefaultHandler,
            'aria-label': (0, i18n_1.default)('label_clear-button'),
        }, children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { data: icons_1.Xmark, size: ICON_SIZE }) }));
};
