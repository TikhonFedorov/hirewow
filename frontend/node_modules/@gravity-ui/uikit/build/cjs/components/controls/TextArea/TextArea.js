...
exports.TextArea = React.forwardRef(function TextArea(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("span", { ref: ref, style: style, className: b({
        ...
        }, className), "data-qa": qa, children: [(0, jsx_runtime_1.jsxs)("span", { className: b('content'), children: [(0, jsx_runtime_1.jsx)(TextAreaControl_1.TextAreaControl, Object.assign({}, props, commonProps, { controlRef: handleRef })), isClearControlVisible && ((0, jsx_runtime_1.jsx)(common_1.ClearButton, { className: b('clear', { size }), size: (0, common_1.mapTextInputSizeToButtonSize)(size), onClick: handleClear }))] }), (0, jsx_runtime_1.jsx)(OuterAdditionalContent_1.OuterAdditionalContent, { errorMessage: isErrorMsgVisible ? errorMessage : null, errorMessageId: errorMessageId, note: note, noteId: noteId })] }));
});
