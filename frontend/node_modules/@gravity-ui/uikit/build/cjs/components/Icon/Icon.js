...
exports.Icon = React.forwardRef(({ data, width, height, size, className, fill = 'currentColor', stroke = 'none', qa }, ref) => {
    ...
    if ((0, utils_1.isStringSvgData)(data)) {
        ...
        return (0, jsx_runtime_1.jsx)("svg", Object.assign({}, props, { ref: ref, dangerouslySetInnerHTML: { __html: preparedData } }));
    }
    if ((0, utils_1.isSpriteData)(data)) {
        const href = exports.Icon.prefix + (data.url || `#${data.id}`);
        return ((0, jsx_runtime_1.jsx)("svg", Object.assign({}, props, { viewBox: viewBox, ref: ref, children: (0, jsx_runtime_1.jsx)("use", { href: href, xlinkHref: href }) })));
    }
    ...
    return ((0, jsx_runtime_1.jsx)("svg", Object.assign({}, props, { ref: ref, children: (0, jsx_runtime_1.jsx)(IconComponent, { width: undefined, height: undefined }) })));
});
