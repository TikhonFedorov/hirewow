...
const DefaultRowActions = ({ index, item, getRowActions, getRowDescriptor, rowActionsSize, isRowDisabled, tableQa, }) => {
    var _a;
    ...
    return _a = class extends React.Component {
            constructor() {
                ...
                this.renderBodyCell = (item, index) => {
                    ...
                    return ((0, jsx_runtime_1.jsx)(DefaultRowActions, { index: index, item: item, getRowActions: getRowActions, rowActionsSize: rowActionsSize, getRowDescriptor: getRowDescriptor, isRowDisabled: isRowDisabled, tableQa: qa }));
                };
