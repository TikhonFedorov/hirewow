...
const DropdownMenuPopup = ({ items, open, anchorRef, onClose, size, menuProps, children, popupProps, path = [], }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Popup_1.Popup, Object.assign({ open: open, anchorRef: anchorRef, onClose: onClose }, popupProps, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, children: children || ((0, jsx_runtime_1.jsx)(Menu_1.Menu, Object.assign({ className: (0, DropdownMenu_classname_1.cnDropdownMenu)('menu'), size: size }, menuProps, { children: items.map((item, index) => {
                var _a;
                ...
                return ((0, jsx_runtime_1.jsx)(DropdownMenuItem_1.DropdownMenuItem, Object.assign({ className: (0, DropdownMenu_classname_1.cnDropdownMenu)('menu-item', {
