...
class ListItem extends React.Component {
    ...
    render() {
        ...
        (0, jsx_runtime_1.jsxs)("div", Object.assign({ role: role, "aria-selected": selected, "aria-disabled": item.disabled, "data-qa": active ? constants_1.ListQa.ACTIVE_ITEM : undefined, className: b('item', {
                sortable,
                active,
                selected,
