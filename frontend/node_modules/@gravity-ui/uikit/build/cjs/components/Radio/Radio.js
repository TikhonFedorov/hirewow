...
exports.Radio = React.forwardRef(function Radio(props, ref) {
    ...
    const control = ((0, jsx_runtime_1.jsxs)("span", { className: b('indicator'), children: [(0, jsx_runtime_1.jsx)("span", { className: b('disc') }), (0, jsx_runtime_1.jsx)("input", Object.assign({}, inputProps, { className: b('control') })), (0, jsx_runtime_1.jsx)("span", { className: b('outline') })] }));
