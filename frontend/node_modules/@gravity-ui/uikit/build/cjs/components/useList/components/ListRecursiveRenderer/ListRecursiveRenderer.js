...
function ListItemRecursiveRenderer(_a) {
    ...
    if ((0, isTreeItemGuard_1.isTreeItemGuard)(itemSchema) && itemSchema.children) {
        ...
        return ((0, jsx_runtime_1.jsxs)("ul", { style: props.style, className: b(null, props.className), role: "group", children: [node, isExpanded &&
                    ...
                    itemSchema.children.map((item, index) => ((0, jsx_runtime_1.jsx)(ListItemRecursiveRenderer, Object.assign({ list: list, id: list.structure.groupsState[id].childrenIds[index], itemSchema: item }, props), index)))] }));
    }
    return node;
}
