...
exports.ListItemView = React.forwardRef(function ListItemView(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Tag, Object.assign({ [constants_1.LIST_ITEM_DATA_ATR]: id, role: role, "aria-selected": selected, onClick: onClick, className: (0, styles_1.b)({
        ...
        }, (0, layout_1.spacing)({ px: 2 }, className)), style: style, ref: ref }, rest, { children: (0, ListItemViewContent_1.isListItemContentPropsGuard)(content) ? ((0, jsx_runtime_1.jsx)(ListItemViewContent_1.ListItemViewContent, Object.assign({}, content, { hasSelectionIcon: selectionViewType === 'multiple', selected: selected, disabled: disabled }))) : (content) })));
});
