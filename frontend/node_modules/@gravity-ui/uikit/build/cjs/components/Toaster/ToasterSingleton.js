...
class ToasterSingleton {
    ...
    render() {
        const container = ((0, jsx_runtime_1.jsx)(ToasterProvider_1.ToasterProvider, { ref: (api) => {
                this.componentAPI = api;
            }, children: (0, jsx_runtime_1.jsx)(ToasterComponent_1.ToasterComponent, { hasPortal: false, mobile: this.mobile }) }));
        if (this.reactRoot) {
