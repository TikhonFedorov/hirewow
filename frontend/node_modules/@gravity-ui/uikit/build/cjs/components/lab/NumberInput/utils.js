...
exports.areStringRepresentationOfNumbersEqual = exports.updateCursorPosition = exports.clampToNearestStepValue = exports.getInternalState = exports.getParsedValue = exports.getPossibleNumberSubstring = exports.prepareStringValue = exports.getInputPattern = exports.CONTROL_BUTTONS_QA = exports.DECREMENT_BUTTON_QA = exports.INCREMENT_BUTTON_QA = void 0;
exports.INCREMENT_BUTTON_QA = 'increment-button-qa';
exports.DECREMENT_BUTTON_QA = 'decrement-button-qa';
exports.CONTROL_BUTTONS_QA = 'control-buttons-qa';
function getInputPattern(withoutFraction, positiveOnly = false) {
    return `^([${positiveOnly ? '' : '\\-'}\\+]?\\d+${withoutFraction ? '' : '(?:(?:.|,)?\\d+)?'})+$`;
}
exports.getInputPattern = getInputPattern;
...
exports.prepareStringValue = prepareStringValue;
...
exports.getPossibleNumberSubstring = getPossibleNumberSubstring;
...
function clampToNearestStepValue({ value, step, min: originalMin, max = Number.MAX_SAFE_INTEGER, direction, }) {
...
exports.clampToNearestStepValue = clampToNearestStepValue;
...
exports.areStringRepresentationOfNumbersEqual = areStringRepresentationOfNumbersEqual;
