...
exports.RadioGroup = React.forwardRef(function RadioGroup(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({}, containerProps, { ref: ref, style: style, className: b({ size, direction }, className), "data-qa": qa, children: optionsProps.map((optionProps) => ((0, react_1.createElement)(Radio_1.Radio, Object.assign({}, optionProps, { key: optionProps.value, className: b('option', optionClassName), size: size })))) })));
});
