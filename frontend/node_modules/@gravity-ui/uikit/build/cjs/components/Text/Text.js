 ...
 * ```
 */
exports.Text = React.forwardRef(function Text(_a, ref) {
    var { as, children, variant, className, ellipsis, color, whiteSpace, wordBreak, ellipsisLines, style: outerStyle, qa } = _a, rest = tslib_1.__rest(_a, ["as", "children", "variant", "className", "ellipsis", "color", "whiteSpace", "wordBreak", "ellipsisLines", "style", "qa"]);
    const Tag = as || 'span';
    const style = Object.assign({}, outerStyle);
    if (typeof ellipsisLines === 'number') {
        style.WebkitLineClamp = ellipsisLines;
    }
    return ((0, jsx_runtime_1.jsx)(Tag, Object.assign({ ref: ref, className: (0, text_1.text)({
            variant,
            ellipsis,
            whiteSpace,
            wordBreak,
