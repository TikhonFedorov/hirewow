...
function DisclosureDetails({ children }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_transition_group_1.CSSTransition, { nodeRef: containerRef, in: expanded, addEndListener: (done) => { var _a; return (_a = containerRef.current) === null || _a === void 0 ? void 0 : _a.addEventListener('animationend', done); }, classNames: (0, transition_1.getCSSTransitionClassNames)(constants_1.b), mountOnEnter: !keepMounted, unmountOnExit: !keepMounted, appear: true, children: (0, jsx_runtime_1.jsx)("div", { ref: containerRef, id: ariaControls, role: "region", "aria-labelledby": ariaLabelledby, className: (0, constants_1.b)('content', { visible: expanded }), "data-qa": constants_1.DisclosureQa.DETAILS, children: children }) }));
}
