...
exports.Palette = React.forwardRef(function Palette(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({}, (0, filterDOMProps_1.filterDOMProps)(props, { labelable: true }), gridProps, { ref: handleRef, className: b({ size }, className), style: style, "data-qa": qa, children: rows.map((row, rowNumber) => ((0, jsx_runtime_1.jsx)("div", { className: b('row', rowClassName), role: "row", children: row.map((option) => {
                var _a;
                const isSelected = Boolean(value.includes(option.value));
                const focused = option === focusedOption;
                return ((0, jsx_runtime_1.jsx)("div", { role: "gridcell", "aria-selected": focused ? 'true' : undefined, "aria-readonly": option.disabled, children: (0, jsx_runtime_1.jsx)(Button_1.Button, { className: b('option', optionClassName), tabIndex: -1, style: style, disabled: disabled || option.disabled, title: option.title, view: isSelected ? 'normal' : 'flat', selected: isSelected, extraProps: { value: option.value }, size: size, onClick: () => handleSelection(option), children: (0, jsx_runtime_1.jsx)(Button_1.Button.Icon, { children: (_a = option.content) !== null && _a !== void 0 ? _a : option.value }) }) }, option.value));
            }) }, `row-${rowNumber}`))) })));
});
